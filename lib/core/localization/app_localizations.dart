...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'fr': {
      ...
      'find_medicine': 'Trouver un médicament',
      'medicines': 'Médicaments',
      'pharmacies': 'Pharmacies',
      'no_medicine_found': 'Aucun médicament trouvé.',
      'no_pharmacy_found': 'Aucune pharmacie trouvée.',
      'available': 'Disponible',
      'out_of_stock': 'Rupture',
      'pharmacies_nearby_count': 'pharmacie(s) à proximité',
      'out_of_stock_area': 'Rupture de stock dans les environs.',
    },
    'wo': {
      'app_title': 'QueueCare SN',
      ...
      'search_pharmacy': 'Wër fàrmasi...',
      'find_medicine': 'Wër saafara',
      'medicines': 'Garab yi',
      'pharmacies': 'Fàrmasi yi',
      'no_medicine_found': 'Gisunu garab gi.',
      'no_pharmacy_found': 'Gisunu fàrmasi.',
      'available': 'Am na',
      'out_of_stock': 'Jeex na',
      'pharmacies_nearby_count': 'fàrmasi yi ci sa wet',
      'out_of_stock_area': 'Jeex na ci wet gi.',
    },
  };
